...
class simpulP10prak1 { // bagian deklarasi struktur record ------------------------------
  String nama;
  String alamat;
  int umur;
  char jekel;
  ...
  float ipk;
  simpulP10prak1 kiri;
  simpulP10prak1 kanan;
}

class senaraiGandaP10prak1 {
  public static simpulP10prak1 awal;
  public static simpulP10prak1 akhir;
  ...
  public static void tambahDepan() { // ------------bagian entri data dari keyboard--------------
    ...
    // ------------bagian menciptakan & mengisi simpulP10prak1 baru--------------
    simpulP10prak1 baru;
    baru = new simpulP10prak1();
    baru.nama = NAMA;
    baru.alamat = ALAMAT;
    baru.umur = UMUR;
    baru.jekel = JEKEL;
    ...
    // --------bagian mencangkokkan simpulP10prak1 baru ke dalam simpulP10prak1 lama----------
  ...
  public static void tambahTengah() {
    ...
    if (LOKASI == 1)
      ...
      // ------------bagian menciptakan & mengisi simpulP10prak1 baru-----------
      simpulP10prak1 baru = new simpulP10prak1();
      baru.nama = NAMA;
      baru.alamat = ALAMAT;
      baru.umur = UMUR;
      baru.jekel = JEKEL;
      ...
      // ------bagian mencangkokkan simpulP10prak1 baru ke dalam linkedlist lama------
