...
class simpulP10prak2 { // bagian deklarasi struktur record ------------------------------
  String nama;
  String alamat;
  int umur;
  char jekel;
  ...
  float ipk;
  simpulP10prak2 kiri;
  simpulP10prak2 kanan;
}

class senaraiGandaP10prak2 {
  public static simpulP10prak2 awal;
  public static simpulP10prak2 akhir;
  ...
  public static void tambahDepan() { // ------------bagian entri data dari keyboard--------------
    ...
    // ------------bagian menciptakan & mengisi simpulP10prak2 baru--------------
    simpulP10prak2 baru;
    baru = new simpulP10prak2();
    baru.nama = NAMA;
    baru.alamat = ALAMAT;
    baru.umur = UMUR;
    baru.jekel = JEKEL;
    ...
    // --------bagian mencangkokkan simpulP10prak2 baru ke dalam simpulP10prak2 lama----------
  ...
  public static void tambahTengah() {
    ...
    if (LOKASI == 1)
      ...
      // ------------bagian menciptakan & mengisi simpulP10prak2 baru-----------
      simpulP10prak2 baru = new simpulP10prak2();
      baru.nama = NAMA;
      baru.alamat = ALAMAT;
      baru.umur = UMUR;
      baru.jekel = JEKEL;
      ...
      // ------bagian mencangkokkan simpulP10prak2 baru ke dalam linkedlist lama------
