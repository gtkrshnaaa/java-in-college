...
public class p3_masterProgramPlus5titik3 {
    ...
    public static void mengurutkanDataBubble(formatBiodata biodataMahasiswa[]) {
        ...
        System.out.println("Data telah diurutkan berdasarkan nama (Bubble Sort).");
    }
    ...
    public static void mengurutkanDataSelection(formatBiodata biodataMahasiswa[]) {
        ...
        for (int i = 0; i <= N - 2; i++) {
            teksTerkecil = biodataMahasiswa[i].nama;
            lokasi = i;
        ...
        System.out.println("Data telah diurutkan berdasarkan nama (Selection Sort).");
    }
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("15. Urutkan Data (Insertion Sort)");
