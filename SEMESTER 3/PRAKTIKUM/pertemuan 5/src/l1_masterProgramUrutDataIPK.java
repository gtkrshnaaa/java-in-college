...
public class l1_masterProgramUrutDataIPK {
    ...
    public static void mengurutkanDataBubble(formatBiodata biodataMahasiswa[]) {
        ...
        System.out.println("Data telah diurutkan berdasarkan IPK (Bubble Sort).");
    }
    ...
    public static void mengurutkanDataSelection(formatBiodata biodataMahasiswa[]) {
        ...
        for (int i = 0; i < N - 1; i++) {
            ...
            for (int j = i + 1; j < N; j++) {
                if (biodataMahasiswa[j].ipk < biodataMahasiswa[lokasi].ipk) {
                    lokasi = j;
                }
            }
        ...
        System.out.println("Data telah diurutkan berdasarkan IPK (Selection Sort).");
    }
    ...
    public static void mengurutkanDataInsertion(formatBiodata biodataMahasiswa[]) {
        ...
        System.out.println("Data telah diurutkan berdasarkan nama (Insertion Sort).");
    }
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("14. Urutkan Data (Selection Sort)");
            System.out.println("14. Urutkan Data (Insertion Sort)");
            ...
            switch (choice) {
                ...
                case 15:
                    ...
                    break;                
                default:
                    System.out.println("Pilihan tidak valid. Silakan pilih menu (1-15).");
            }
        }
    }
}
