...
class t1_hashingCariData {
    ...
    public static void cariData(formatBiodata biodataMahasiswa[]) {
        ...
        int nimCari = masukan.nextInt();

        int NH = hitungNilaiHash(nimCari);

        while (biodataMahasiswa[NH].nama != null) {
            if (biodataMahasiswa[NH].nim == nimCari) {
                System.out.println("Data ditemukan pada indeks: " + NH);
                System.out.println("NO NAMA ALAMAT UMUR JEKEL IPK ");
                System.out.print(NH + " ");
                System.out.print(biodataMahasiswa[NH].nama + "\t ");
                System.out.print(biodataMahasiswa[NH].alamat + "\t ");
                System.out.print(biodataMahasiswa[NH].umur + "\t ");
                System.out.print(biodataMahasiswa[NH].jekel + "\t ");
                System.out.println(biodataMahasiswa[NH].ipk);
                return;
            }
            NH++;
        }
