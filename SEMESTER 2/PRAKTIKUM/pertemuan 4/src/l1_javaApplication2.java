...
public class l1_javaApplication2 {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("---------------------------");
        System.out.println();
        System.out.println("\t\tTest1\tTest2\tTest3\tRata-rata");
...
// modifikasi program ini dengan menambahkan inputan berupa Nama, NIM, dan Jurusan untuk masing masing mahasiswa